...
export default {
  ...
  <div class="overlay">
    ...
    <div class="modal" style="padding: 36px; display: grid; gap: 20px; max-width: 400px; text-align: center;">
      ...
      <div style="line-height: 1.5em; opacity: 0.5">The project was implemented by Estonian <a href="https://www.artun.ee/en/home">Academy of Arts</a> digital product design students in Jan 2021. Source code is <a href="https://github.com/kristjanjansen/eka_virtual">available here</a>.</div>
    </div>
  </div>
  `,
};
